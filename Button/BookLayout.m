...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
   ...
   // /*
    ...
    CGFloat ratio = - 0.5 + page - (self.collectionView.contentOffset.x / self.collectionView.bounds.size.width);
    ...
    //计算旋转角度angle,设定3D旋转
    CGFloat newRatio = MIN(MAX(ratio, -1), 1);// (-1 ~ 1)
